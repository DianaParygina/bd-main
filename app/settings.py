...
SECRET_KEY = 'django-insecure-vw_j5csb#z=#+ww&0%)ib%fyg6x_31tu&2esg@et%)t3rsy9e8'
...
DATABASES = {
    'default': {
        'ENGINE': 'mssql', # Обратите внимание на изменение здесь
        'NAME': 'personal_data',
        'USER': 'django_user',
        'PASSWORD': 'djangoUser123',
        'HOST' : 'localhost',
        'PORT': '1433', #  Можно опустить, если используется порт по умолчанию (1433)
        'OPTIONS': {
